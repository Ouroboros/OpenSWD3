...

    {
        ...
        test.expect_true(
            result.status ==
                ...
                result.port_calls == 1U && result.random_calls == 0U &&
                ...
                fixture.port.calls[0U].object_token == 0x005029D0U &&
                fixture.port.calls[0U].arguments[0U] == 1U &&
                fixture.port.calls[0U].eax == 0U &&
                fixture.port.calls[0U].edx == 8U,
            "processed group-B byte at or above the signed count returns count and zero-extended byte after preparing the actor"
        );
    }
...

    {
        ...
        test.expect_true(
            result.status ==
                ...
                fixture.port.calls[1U].object_token == 0x0052AB58U &&
                fixture.port.calls[1U].eax == 0x102FU &&
                fixture.port.calls[1U].ecx == 0x0052AB58U &&
                fixture.port.calls[1U].edx == 0x09CFU &&
