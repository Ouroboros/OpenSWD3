...
int main() {
    ...
    test_battle_actor_message_percent_refresh(test);
    ...
    test_battle_debug_status_panel(test);
    test_battle_defeat_panel(test);
    ...
    test_battle_actor_record_selection(test);
    test_battle_actor_frame_resource(test);
    test_battle_actor_frame_snapshot_clear(test);
    test_battle_actor_turn_completion(test);
    test_battle_actor_idle_state(test);
    test_battle_actor_action_kind(test);
    test_battle_actor_action_mode(test);
    ...
    test_battle_actor_start_gate_latch_query(test);
    ...
    test_battle_level_advancement(test);
    test_battle_level_growth_panel(test);
    test_battle_level_up_panel(test);
    ...
    test_battle_menu_page_advance(test);
    ...
    test_battle_group_b_action_item_special_option(test);
    ...
    test_battle_growth_item_completion_panel(test);
    test_battle_growth_item_result_selection(test);
    ...
    test_battle_group_b_script_special_action_item_parameters_script_caller(
        test
    );
