#include "openswd3/battle/legacy_battle_available_actor_reverse_cycle.hpp"
...
class AvailableActorReverseCyclePort final
...
struct Fixture {
    ...
    AvailableActorReverseCyclePort port;
};
...
void test_battle_available_actor_reverse_cycle(openswd3::test::Context& test) {
    ...
    using openswd3::battle::reverse_cycle_legacy_battle_available_actor;

    {
        Fixture fixture;
        fixture.metrics.group_a_count = 2U;
        fixture.final_actor.actor_order[0U] = 10U;
        fixture.final_actor.actor_order[1U] = 11U;
        ...
        const auto result = reverse_cycle_legacy_battle_available_actor(
        ...
        test.expect_true(
            ...
            "reverse candidate ten falls through to available candidate eleven and preserves its callee registers"
        );
    }

    {
        ...
        test.expect_true(
            ...
            "four unavailable reverse candidates wrap below zero and then return zero"
        );
    }
...

    {
        ...
        test.expect_true(
            ...
            "adjacent reverse candidate two stops at its first real group-A actor access"
        );
    }
}
