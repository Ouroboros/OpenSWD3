...
void test_battle_menu_input_finalize(openswd3::test::Context& test) {
...

    {
        ...
        test.expect_true(
            fixture.message == 1U && fixture.frame.list_selection == 1U &&
                ...
                result.active_group_a_cleanup.explicit_words_zeroed == 11U &&
                fixture.port.calls.empty(),
...

    {
        ...
        test.expect_true(
            result.status == LegacyBattleMenuInputFinalizeStatus::completed &&
                ...
                fixture.port.calls.size() == 12U &&
                fixture.port.calls[0U].ecx == 0x00525508U &&
                fixture.port.calls[1U].ecx == 0x00528030U &&
                fixture.port.calls[2U].ecx == 0x005029D0U &&
                fixture.port.calls[11U].ecx == 0x0051D2A4U &&
        ...
        for (const auto item : {
            ...
            test.expect_true(
                result.status ==
                    ...
                    result.active_group_a_cleanup.explicit_words_zeroed ==
                        11U &&
                    fixture.port.calls.size() == 10U,
...

    {
        ...
        test.expect_true(
            fixture.message == 1U && fixture.input.action_kind == 30U &&
                ...
                result.return_eax == 30U &&
                result.return_ecx == 0x0051D2A4U &&
                result.return_edx == 0x005029D0U &&
                fixture.port.calls.size() == 10U,
...

    {
        ...
        test.expect_true(
            result.status ==
                ...
                fixture.port.calls.size() == 8U && result.return_eax == 9U &&
...

    {
        ...
        for (const auto item : {
                 MessageCase{4U, 1U, 0x005029D0U},
                 MessageCase{5U, 4U, 0x005029D0U},
                 MessageCase{8U, 1U, 0x005029D0U},
                 MessageCase{27U, 1U, 0x005029D0U},
                 MessageCase{30U, 1U, 0x005029D0U},
             }) {
            Fixture fixture;
