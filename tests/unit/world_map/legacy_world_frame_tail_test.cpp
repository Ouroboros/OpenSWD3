...
void test_normal_advance(openswd3::test::Context& test) {
    ...
    advance_legacy_world_tile_layer_animation(state);
    test.expect_true(
        state.cycle_counter == 0 && state.frame_index == 2U &&
            state.frame_direction == 1 && state.tile_layer_offset == 200U,
...
void test_ping_pong_boundaries(openswd3::test::Context& test) {
    ...
    test.expect_true(
        upper.cycle_counter == 0 && upper.frame_index == 2U &&
            upper.frame_direction == -1 && upper.tile_layer_offset == 200U,
    ...
    test.expect_true(
        lower.cycle_counter == 0 && lower.frame_index == 1U &&
            lower.frame_direction == 1 && lower.tile_layer_offset == 100U,
...
void test_noncanonical_animation_values(openswd3::test::Context& test) {
    ...
    test.expect_true(
        zero_frames.frame_index == 0xFFFFFFFFU &&
