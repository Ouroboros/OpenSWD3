...
constexpr std::array<MappedRange, 112> kMappedRanges{{
    ...
    {0x004A7644U, 0x02U},  {0x004FF2F0U, 0x14U},  {0x00525434U, 0x14U},
    {0x0053BF12U, 0x06U},  {0x004CAE7CU, 0x04U},  {0x004FF578U, 0x04U},
    {0x004FDF7CU, 0x02U},  {0x004FDF8CU, 0x04U},  {0x004FDFA4U, 0x04U},
    {0x004FE5CCU, 0x30U},  {0x005028A0U, 0x08U},  {0x00520D58U, 0x04U},
    ...
    {0x0053AF30U, 0x28U},  {0x00502940U, 0x14U},  {0x0052022CU, 0x50U},
    {0x005202A8U, 0xAB0U}, {0x00520DD0U, 0x28U},  {0x00520D5CU, 0x48U},
    {0x00520E40U, 0x48U},  {0x005213A0U, 0x100U}, {0x005214ACU, 0x48U},
    {0x005214F8U, 0x24U},  {0x0052411CU, 0x48U},  {0x00524268U, 0x20U},
    {0x00524324U, 0xF0U},  {0x00524468U, 0x28U},  {0x005244E8U, 0x1F8U},
    ...
    {0x0052441CU, 0x04U},  {0x0053BCF4U, 0x04U},  {0x0053BD04U, 0x08U},
    {0x0053BD24U, 0x08U},  {0x0053BD40U, 0x04U},  {0x0053BD50U, 0x08U},
    ...
    {0x0053BF24U, 0x04U},  {0x0053BF2AU, 0x02U},  {0x0053BF5CU, 0x04U},
    {0x0053BF60U, 0x04U},  {0x0053BF64U, 0x08U},  {0x0053BF74U, 0x04U},
    {0x0053BF7CU, 0x04U},  {0x0053BF80U, 0x04U},  {0x0053BF88U, 0x04U},
    {0x0053BFA8U, 0x04U},  {0x0053BFC0U, 0x08U},  {0x0053BFB8U, 0x08U},
    {0x0053BFD0U, 0x04U},  {0x0053BFD8U, 0x04U},  {0x0053BFCCU, 0x04U},
    {0x0053BFF4U, 0x04U},  {0x0053C000U, 0x08U},  {0x0053C018U, 0x04U},
    {0x0053BFE4U, 0x04U},  {0x0053C040U, 0x04U},  {0x0053C048U, 0x04U},
    {0x0053C050U, 0x02U},  {0x0053C4A0U, 0x04U},  {0x0053C4C0U, 0x01U},
    {0x0053CEACU, 0x04U},  {0x004A7646U, 0x01U},  {0x004FDC60U, 0x04U},
    {0x004FE5C0U, 0x0CU},  {0x004FE5D2U, 0x02U},  {0x004FE5FCU, 0x0EU},
    {0x00520DF8U, 0x20U},  {0x0052137CU, 0x24U},  {0x0053BCDCU, 0x04U},
    {0x0053BD10U, 0x08U},  {0x0053BDA4U, 0x04U},  {0x0053BDE8U, 0x04U},
    {0x0053BF1EU, 0x04U},  {0x0053BFFCU, 0x04U},  {0x0053C01CU, 0x04U},
    {0x0053C038U, 0x04U},  {0x0053C498U, 0x02U},  {0x0053C4B0U, 0x08U},
    {0x0053C4BCU, 0x04U},
}};
...
void synchronize_typed_aliases(
    ...
    input_dispatch.retreat_target_word = 0xFFFFU;
    input_dispatch.selected_option_word = 0xFFFFU;
    input_dispatch.frame_value_a = 0U;
    input_dispatch.frame_value_b = 0U;
    ...
    message_phase.transition_mode_gate = 0U;
    message_phase.group_b_bypass_gate = 0U;

    victory_rewards.collected_item_ids[0U] = 0U;
    victory_rewards.collected_item_ids[1U] = 0U;
    victory_rewards.collected_item_quantities[0U] = 0U;
    victory_rewards.collected_item_quantities[1U] = 0U;
    victory_rewards.player_item_tokens.fill(0U);
    victory_rewards.committed_money_word = 0U;
...
LegacyBattleGlobalResetResult reset_legacy_battle_globals(
    ...
    synchronize_typed_aliases(
        ...
        port.battle_message_phase_state(),
