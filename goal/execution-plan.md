...
10. `[>]` B4：B4.2 像素转换、B4.3 owned framebuffer 与 B4.4 稀疏分派及四条基础 copy 已闭环；真实 TSW 固定帧、Linux `core` 42/42、Linux/Windows `app` 44/44 CTest 通过，现执行 B4.5 已赋值 blitter 效果族。
