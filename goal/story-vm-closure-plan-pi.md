...
状态：执行中，P0/P1 已完成，当前步骤 P2；下一handler `0x0042C2C6`（opcode134）
...
- `0..133`及`167..168`已有人工汇编语义；其余`134..193`目前只有分派、长度和保守 CFG，尚不能直接翻译为 C++。
...
LLVM app完整门，192/192以exit0通过且未启动游戏EXE。P2当前人工语义已随审计增至146行。前107行已独立
...
192/192完整门均以exit 0通过；已实现150/198、已验收146/198；内部workpack为107/146，即`15 assembly_exact + 92 platform_adapted +
39 pending_audit`。下一行只审计`0x0042C2C6`下的opcode134。
