...
状态：执行中，P0/P1 已完成，当前步骤 P2；下一handler `0x0042C858`（opcode150）
...
- `0..144`、`147..149`及`167..168`已有人工汇编语义；其余`150..193`目前只有分派、长度和保守 CFG，尚不能直接翻译为 C++。
...
为118/146，即`18 assembly_exact + 100 platform_adapted + 28 pending_audit`。下一行只审计
`0x0042C858`下的opcode150。
