...
状态：执行中，P0/P1 已完成，当前步骤 P2；下一handler `0x0042B8E6`（opcode118）
...
LLVM app完整门，192/192以exit0通过且未启动游戏EXE。P2当前人工语义已随审计增至135行。前93行已独立
...
core186/186、app192/192通过。已实现132/198、已验收127/198；
内部workpack为93/146，即
`13 assembly_exact + 80 platform_adapted + 53 pending_audit`。下一行只审计`0x0042B8E6`下的opcode118。
