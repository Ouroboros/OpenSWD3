...
状态：执行中，P0/P1 已完成，当前步骤 P2；当前 handler `0x00428679`（opcode 26）
...
schedule、共享opcode21/22全局bit条件跳转、opcode23全局bit列表全真跳转，以及opcode24
全局bit列表任真跳转，以及opcode25全局位置位。当前为20/146；下一行只审计`0x00428679`的
opcode26 handler。
