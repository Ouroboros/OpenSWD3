...
状态：执行中，P0/P1 已完成，当前步骤 P2；当前 handler `0x0042A2C6`（opcode 82）
...
值、窗口、公共 join/yield 与返回路径。P2当前人工语义已随审计增至127行。前62行已独立
...
opcode81创建0xB4头像动作，保持signed X、low15 Y、bit15特殊motion、前插、previous与same-call。
已实现99/198、已验收86/198；内部workpack为62/146，即
`8 assembly_exact + 54 platform_adapted + 84 pending_audit`。下一行只审计`0x0042A2C6`下的opcode82。
