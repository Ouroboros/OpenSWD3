...
LLVM app完整门，192/192以exit0通过且未启动游戏EXE。P2当前人工语义已随审计增至128行。前71行已独立
...
0x400-byte owner外裸写在selector8163起按原访问点typed-stop。
已实现106/198、已验收96/198；内部workpack为71/146，即
`8 assembly_exact + 63 platform_adapted + 75 pending_audit`。下一行只审计`0x0042A792`下的opcode93。
