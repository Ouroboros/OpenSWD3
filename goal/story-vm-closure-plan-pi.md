...
状态：执行中，P0/P1 已完成，当前步骤 P2；当前 handler `0x00428BA0`（opcode 40）
...
值、窗口、公共 join/yield 与返回路径。P2当前人工语义已随审计增至126行。前三十行已独立
...
opcode38角色场景清除与MAPS fallback，以及opcode39角色bit15标记、surface清除与one-shot复位。
当前为30/146；下一行只审计`0x00428BA0`的opcode40 handler。
