...
状态：执行中，P0/P1 已完成，当前步骤 P2；下一handler `0x0042CA7C`（opcodes158–159）
...
- `0..144`、`147..152`、`155..157`及`167..168`已有人工汇编语义；其余`158..193`目前只有分派、长度和保守 CFG，尚不能直接翻译为 C++。
...
下一行只审计`0x0042CA7C`下的opcodes158–159。
