...
状态：执行中，P0/P1 已完成，当前步骤 P2；下一shared handler `0x0042B070`（opcodes181–185）
...
- `0..144`、`147..152`、`155..168`、`170..173`及`175..180`已有人工汇编语义；其余opcode目前只有分派、长度和保守 CFG，尚不能直接翻译为 C++。
...
下一行只审计`0x0042B070`下的opcodes181–185共享handler。
