...
状态：执行中，P0/P1 已完成，当前步骤 P2；当前 handler `0x004284C2`（opcode 19）
...
值、窗口、公共 join/yield 与返回路径。P2 前十四行已独立关闭：默认非法与共享对话两组、
...
conditional jump 与 opcode18 role-path release。当前为 14/146；下一行只审计 `0x004284C2`
的 opcode19。
