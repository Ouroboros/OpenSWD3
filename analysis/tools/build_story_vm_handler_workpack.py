...
EXPECTED_MODERN_CASE_COUNT = 188
EXPECTED_CLOSED_HANDLER_COUNT = 137
...
CLOSURE_OVERRIDES = {
    ...
    "0x0042BAB8": (
        "platform_adapted",
        "story-vm-role-action-fields-0042bab8.md",
        "assembly_exact;unit_tested;real_asset_tested;platform_adapted;sdl_runtime_integrated;exact_tail_tested;staged_operand_tested;selector_alias_tested;partial_failure_tested;external_dependency_tested;typed_owner_boundary_tested",
    ),
    "0x0042BC2C": (
        "assembly_exact",
        "story-vm-text-control-bit26-clear-0042bc2c.md",
        "assembly_exact;unit_tested;real_asset_tested;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;shared_owner_tested",
    ),
    "0x0042BC3D": (
        "platform_adapted",
        "story-vm-speed-mode-clear-0042bc3d.md",
        "assembly_exact;unit_tested;real_asset_tested;platform_adapted;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;shared_owner_tested;typed_owner_boundary_tested",
    ),
    "0x0042BC4C": (
        "platform_adapted",
        "story-vm-scene-music-table-entry-0042bc4c.md",
        "assembly_exact;unit_tested;real_asset_tested;platform_adapted;sdl_runtime_integrated;exact_tail_tested;staged_operand_tested;selector_alias_tested;partial_failure_tested;typed_owner_boundary_tested",
    ),
    "0x0042BCF5": (
        "assembly_exact",
        "story-vm-text-control-bit25-clear-0042bcf5.md",
        "assembly_exact;unit_tested;asset_absence_verified;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;shared_owner_tested",
    ),
    "0x0042BD06": (
        "platform_adapted",
        "story-vm-text-allocation-append-0042bd06.md",
        "assembly_exact;unit_tested;asset_absence_verified;platform_adapted;sdl_runtime_integrated;exact_tail_tested;staged_operand_tested;selector_alias_tested;partial_failure_tested;shared_owner_tested;typed_owner_boundary_tested",
    ),
    "0x0042BDBC": (
        "platform_adapted",
    ...
    "0x0042BEFE": (
        "platform_adapted",
        "story-vm-item-presence-reload-0042befe.md",
        "assembly_exact;unit_tested;real_asset_tested;platform_adapted;sdl_runtime_integrated;exact_tail_tested;staged_operand_tested;selector_alias_tested;shared_handler_all_variants_tested;partial_failure_tested;shared_owner_tested;typed_owner_boundary_tested",
    ),
    "0x0042BF72": (
        "platform_adapted",
        "story-vm-party-item-conditional-add-0042bf72.md",
        "assembly_exact;unit_tested;asset_absence_verified;platform_adapted;sdl_runtime_integrated;exact_tail_tested;staged_operand_tested;selector_alias_tested;partial_failure_tested;shared_owner_tested;external_dependency_tested;typed_owner_boundary_tested",
    ),
    "0x0042C033": (
        "platform_adapted",
        "story-vm-player-item-role-slot-swap-0042c033.md",
        "assembly_exact;unit_tested;asset_absence_verified;platform_adapted;sdl_runtime_integrated;exact_tail_tested;staged_operand_tested;selector_alias_tested;partial_failure_tested;shared_owner_tested;external_dependency_tested;typed_owner_boundary_tested",
    ),
    "0x0042C234": (
        "platform_adapted",
    ...
    "0x0042C2C6": (
        "platform_adapted",
        "story-vm-party-member-resources-0042c2c6.md",
        "assembly_exact;unit_tested;real_asset_tested;platform_adapted;sdl_runtime_integrated;exact_tail_tested;staged_operand_tested;selector_alias_tested;partial_failure_tested;shared_owner_tested;external_dependency_tested;self_modification_tested;adjacent_pending_handler_tested;typed_owner_boundary_tested",
    ),
    "0x0042C3B0": (
        "platform_adapted",
    ...
    "0x0042C3F7": (
        "platform_adapted",
        "story-vm-scene-music-stream-stop-0042c3f7.md",
        "assembly_exact;unit_tested;real_asset_tested;platform_adapted;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;shared_owner_tested;helper_reuse_tested;no_audio_tested;initialization_tested",
    ),
    "0x0042C49E": (
        "platform_adapted",
        "story-vm-role-distance-reload-0042c49e.md",
        "assembly_exact;unit_tested;real_asset_tested;platform_adapted;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;staged_operand_tested;partial_failure_tested;shared_owner_tested;helper_reuse_tested;x87_compatibility_tested;typed_owner_boundary_tested",
    ),
    "0x0042C6DD": (
        "platform_adapted",
        "story-vm-music-stream-transition-config-0042c6dd.md",
        "assembly_exact;unit_tested;real_asset_tested;platform_adapted;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;staged_operand_tested;partial_failure_tested;shared_owner_tested;no_audio_tested",
    ),
    "0x0042C732": (
        "platform_adapted",
        "story-vm-primary-countdown-initialize-0042c732.md",
        "assembly_exact;unit_tested;real_asset_tested;platform_adapted;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;staged_operand_tested;wrapping_tested;shared_owner_tested;helper_reuse_tested;typed_owner_boundary_tested;audio_yield_tested",
    ),
    "0x0042C766": (
        "platform_adapted",
        "story-vm-primary-countdown-disable-0042c766.md",
        "assembly_exact;unit_tested;real_asset_tested;platform_adapted;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;shared_owner_tested;typed_owner_boundary_tested;side_effect_order_tested;audio_yield_tested",
    ),
    "0x0042C79D": (
        "platform_adapted",
        "story-vm-special-mode-four-five-request-0042c79d.md",
        "assembly_exact;unit_tested;real_asset_tested;platform_adapted;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;staged_operand_tested;partial_failure_tested;unread_padding_tested;shared_owner_tested;typed_owner_boundary_tested;side_effect_order_tested;audio_yield_tested;composition_tested",
    ),
    "0x0042C7FB": (
        "assembly_exact",
        "story-vm-fixed-story-flag-70-set-0042c7fb.md",
        "assembly_exact;unit_tested;real_asset_tested;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;shared_owner_tested;idempotence_tested;bit_isolation_tested;audio_yield_tested",
    ),
    "0x0042C81A": (
        "assembly_exact",
        "story-vm-fixed-story-flag-19-set-0042c81a.md",
        "assembly_exact;unit_tested;asset_absence_verified;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;shared_owner_tested;idempotence_tested;bit_isolation_tested;audio_yield_tested",
    ),
    "0x0042C839": (
        "assembly_exact",
        "story-vm-fixed-story-flag-19-clear-0042c839.md",
        "assembly_exact;unit_tested;asset_absence_verified;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;shared_owner_tested;idempotence_tested;bit_isolation_tested;audio_yield_tested",
    ),
    "0x0042C858": (
        "platform_adapted",
        "story-vm-ani-follower-position-config-0042c858.md",
        "platform_adapted;unit_tested;asset_absence_verified;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;shared_owner_tested;staged_operand_tested;staged_write_tested;signed_clamp_tested;original_bug_tested;audio_yield_tested",
    ),
    "0x0042C8F8": (
        "platform_adapted",
        "story-vm-ani-follower-target-config-0042c8f8.md",
        "platform_adapted;unit_tested;asset_absence_verified;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;shared_owner_tested;staged_operand_tested;staged_write_tested;signed_extremes_tested;audio_yield_tested",
    ),
    "0x0042C936": (
        "platform_adapted",
        "story-vm-ani-follower-target-wait-0042c936.md",
        "platform_adapted;unit_tested;asset_absence_verified;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;shared_owner_tested;short_circuit_tested;wait_complete_tested;previous_publication_tested;audio_yield_tested",
    ),
    "0x0042C95B": (
        "platform_adapted",
        "story-vm-current-world-session-reload-0042c95b.md",
        "platform_adapted;unit_tested;asset_absence_verified;sdl_runtime_integrated;external_dependency_tested;exact_tail_tested;selector_alias_tested;shared_owner_tested;staged_write_tested;original_bug_tested;reload_failure_tested;audio_yield_tested",
    ),
    "0x0042C9CE": (
        "platform_adapted",
        "story-vm-deferred-world-session-reload-0042c9ce.md",
        "platform_adapted;unit_tested;real_asset_tested;sdl_runtime_integrated;external_dependency_tested;exact_tail_tested;selector_alias_tested;shared_owner_tested;signed_gate_tested;deferred_state_tested;staged_write_tested;reload_failure_tested;audio_yield_tested",
    ),
    "0x0042CA3A": (
        "assembly_exact",
        "story-vm-deferred-world-session-config-0042ca3a.md",
        "assembly_exact;unit_tested;asset_absence_verified;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;shared_owner_tested;staged_operand_tested;staged_write_tested;signed_extremes_tested;unread_operand_tested;same_call_tested",
    ),
    "0x0042CA7C": (
        "platform_adapted",
        "story-vm-file-copy-delete-0042ca7c.md",
        "platform_adapted;unit_tested;asset_absence_verified;sdl_runtime_integrated;external_dependency_tested;exact_tail_tested;selector_alias_tested;shared_handler_all_variants_tested;staged_operand_tested;lookahead_tested;unread_operand_tested;embedded_nul_tested;file_failure_tested;host_activation_adapted;same_call_tested",
    ),
    "0x0042CBB0": (
        "assembly_exact",
    ...
    "0x0042CCF7": (
        "platform_adapted",
        "story-vm-mode-text-0042ccf7.md",
        "platform_adapted;unit_tested;real_asset_tested;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;shared_handler_all_variants_tested;shared_owner_tested;variable_record_tested;percent_q_terminator_tested;embedded_nul_tested;staged_operand_tested;partial_failure_tested;fixed_allocation_boundary_tested;owner_lifecycle_tested;initialization_tested;previous_publication_tested;audio_order_tested;yield_tested",
    ),
    "0x0042CDED": (
        "assembly_exact",
        "story-vm-ani-suspend-0042cded.md",
        "assembly_exact;unit_tested;asset_absence_verified;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;shared_owner_tested;full_width_owner_tested;idempotence_tested;write_order_tested;previous_publication_tested;same_call_tested;no_audio_tested",
    ),
    "0x0042CE12": (
        "assembly_exact",
        "story-vm-ani-resume-0042ce12.md",
        "assembly_exact;unit_tested;asset_absence_verified;sdl_runtime_integrated;exact_tail_tested;selector_alias_tested;shared_owner_tested;full_width_owner_tested;idempotence_tested;write_order_tested;previous_publication_tested;audio_order_tested;yield_tested;unread_successor_tested",
    ),
    "0x0042CE32": (
        "platform_adapted",
    ...
    "0x0042CFBD": (
        "platform_adapted",
        "story-vm-frame-deformation-0042cfbd.md",
        "platform_adapted;unit_tested;asset_absence_verified;sdl_runtime_integrated;external_dependency_tested;exact_tail_tested;selector_alias_tested;shared_owner_tested;signed_operand_tested;staged_operand_tested;fixed_surface_tested;fixed_injection_radius_tested;strict_radius_tested;no_rng_valid_path_tested;allocation_failure_adapted;invalid_geometry_tested;partial_failure_tested;previous_publication_tested;same_call_tested;no_audio_tested",
    ),
    "0x0042D041": (
        "platform_adapted",
        "story-vm-frame-execution-gate-clear-0042d041.md",
        "platform_adapted;unit_tested;asset_absence_verified;sdl_runtime_integrated;external_dependency_tested;exact_tail_tested;selector_alias_tested;shared_owner_tested;full_width_owner_tested;idempotence_tested;write_order_tested;typed_owner_boundary_tested;previous_publication_tested;audio_order_tested;yield_tested;unread_successor_tested",
    ),
    "0x0042B070": (
        "platform_adapted",
        "story-vm-wide-global-integers-0042b070.md",
        "platform_adapted;unit_tested;real_asset_tested;asset_absence_verified;sdl_runtime_integrated;external_dependency_tested;exact_tail_tested;selector_alias_tested;shared_owner_tested;full_width_value_tested;wrapping_arithmetic_tested;unsigned_comparison_tested;staged_operand_tested;target_read_order_tested;conditional_reload_tested;shared_clamp_tested;high_index_retry_tested;negative_index_adapted;load_failure_tested;previous_publication_tested;same_call_tested;audio_order_tested",
    ),
}
