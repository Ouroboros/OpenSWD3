...
EXPECTED_SHA256 = {
    ...
    FUNCTION_PATH: "9a149a80e48e81ba64b7a5ea375aed0cf96465343e32a26e19006f29e5a7d687",
}
...
def main() -> None:
    ...
    if len(output_rows) != 45 or len({row[0] for row in output_rows}) != 45:
        raise SystemExit("expected 45 unique A3 state ownership rows")
