...
完整审计纳入2次4239D0、4次40DC50、5次40EBF0、1次AE40、1次B110、5次BAB0、8次436AD0、4次FA70、1次400A0、2次405C0及resource resolve/blit路径。已关闭AE40的可观察调用通过typed render operation表达；FA70/400A0/405C0等未关闭callee继续保持最小port边界，不提前计数。
...
- phase2/10：第一record受物品`1BA9`门控；两个FA70 flags严格由runtime bit0/bit1移到bit12并叠加toggle相等位，随后绘制公共panel/text。
