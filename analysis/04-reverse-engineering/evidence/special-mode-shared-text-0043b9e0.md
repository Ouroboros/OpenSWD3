...
函数写固定128字节共享buffer`0x004FC2A0`。LST共有46个直接调用点，分布于38个caller；参数寄存器分布为EAX 41次、ECX 3次、EDX 2次。八个caller各调用两次：`0x00440B20`、`0x00440C20`、`0x00440D20`、`0x00440E10`、`0x00440F00`、`0x00440FB0`、`0x00441160`和`0x0044E4A0`。
