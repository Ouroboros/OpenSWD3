...
直接caller是`0x004455E0`。`0x0043B480`只保存函数地址，不是运行时direct call。已关闭的`0x0043BBE0`、`0x0043C090`、`0x0043C520`、`0x0043C590`、`0x0043C670`、`0x0043C760`、`0x0043CBD0`与`0x0043CC00`直接复用typed helper；其余未关闭callee继续由窄port隔离。
