...
当前图共有 87 条有向模块依赖，覆盖 1,644 个跨模块函数对和 3,562 个静态调用点；状态合同另外落到 26 条跨所有者写入边和 45 条跨所有者读取边。表内 `reverse_dependency_present=yes` 给出全部直接双向关系，共 34 对；`cycle_component` 给出长环归属。
...
当前依赖表 SHA-256 为 `335d9291a233d6e89ce3e965c951434e97f80511c81f1db36ec1050a032bf5a2`。
