...
无代码、数据或导出引用的 `0x00439C20..0x00439DDD` 快速例程不进入运行时实现，也不用于解释活动资产输出；其 DWORD 超前复制、额外 `-1` 返回和不可达证据见 [`unused-lzo1x-fast-decoder-00439c20.md`](unused-lzo1x-fast-decoder-00439c20.md)。
