...
public:
    ...
    begin_text_surface(compat::i32 width, compat::i32 height) noexcept = 0;
    ...
    virtual void
    set_dialog_clip(const LegacyDialogRectangle& rectangle) noexcept = 0;
    virtual void
    draw_dialog_panel(const LegacyDialogPanelDrawRequest& request) noexcept = 0;
    ...
    virtual void
    draw_dialog_caption(const LegacyDialogCaptionRequest& request) noexcept = 0;
