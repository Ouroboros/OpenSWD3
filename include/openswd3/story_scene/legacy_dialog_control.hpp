...
public:
  ...
  [[nodiscard]] virtual bool close_role_dialog_action(
      compat::u16 role_index) noexcept = 0;
...
[[nodiscard]] LegacyDialogControlApplyResult
apply_legacy_dialog_control_action(
    LegacyDialogMessage &message, LegacyDialogControlAction action,
