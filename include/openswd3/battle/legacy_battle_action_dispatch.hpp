...
struct LegacyBattleActionDispatchContext {
    ...
    LegacyBattleActorTurnCompletionRequest actor_turn_completion_request{};
    ...
    std::array<LegacyBattleActorActionTargetRequest, 4>
        group_a_frame_action_target_requests{};
    std::array<LegacyBattleActorActionTargetRequest, 2>
        group_b_frame_action_target_requests{};
    LegacyBattleActorActionTargetRequest post_action_target_request{};
...
struct LegacyBattleActionDispatchResult {
    ...
    LegacyBattleActorCoordinateQueryResult coordinate_query{};
    compat::u32 coordinate_query_calls{};
    LegacyBattleActorTurnCompletionResult actor_turn_completion{};
    compat::u32 actor_turn_completion_calls{};
    LegacyBattleActorIdleStateResult actor_idle_state{};
    ...
    LegacyBattleGroupBStatusActionResult group_b_status_action{};
    compat::u32 group_b_status_action_calls{};
