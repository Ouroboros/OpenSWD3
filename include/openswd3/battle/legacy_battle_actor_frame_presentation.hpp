...
struct LegacyBattleActorFrameEntryRequest {
    ...
    bool decoder_payload_heap_fill_write_backed{};
    bool decoder_payload_heap_fill_return_stack_backed{};
    bool decoder_payload_heap_allocator_raw_local_backed{};
    bool decoder_payload_heap_allocator_saved_registers_backed{};
    bool decoder_payload_heap_allocator_parent_return_stack_backed{};
    bool decoder_payload_heap_parent_local_backed{};
    bool decoder_payload_heap_wrapper_return_stack_backed{};
    bool decoder_payload_heap_outer_return_stack_backed{};
