...
[[nodiscard]] compat::u32 find_legacy_world_role_by_guid(
    std::span<const LegacyWorldRoleRecord> roles, compat::u16 guid
) noexcept;
...
[[nodiscard]] LegacyWorldRoleGuidResult legacy_world_role_guid_at(
    std::span<const LegacyWorldRoleRecord> roles, compat::u32 role_index
) noexcept;

// 0x0040C100: always store the 0x0040C020 result and return whether it differs
// from 0xFFFFFFFF.
[[nodiscard]] bool lookup_legacy_world_role_by_guid(
