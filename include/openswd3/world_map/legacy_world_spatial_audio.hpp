...
public:
    ...
    virtual void
    set_sample_volume(compat::u16 sound_id, compat::i32 volume) noexcept = 0;
    virtual void
    set_sample_pan(compat::u16 sound_id, compat::i32 pan) noexcept = 0;
};
...
[[nodiscard]] LegacyWorldSpatialAudioResult update_legacy_world_spatial_audio(
