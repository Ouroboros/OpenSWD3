...
public:
    ...
    virtual void configure_debug_text(
        compat::u16 background_color, compat::u16 secondary_color
    ) noexcept = 0;
    [[nodiscard]] virtual rendering::LegacyTextDrawResult draw_debug_text(
        const rendering::LegacyTextDrawRequest& request
    ) noexcept = 0;
