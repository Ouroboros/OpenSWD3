...
[[nodiscard]] LegacyWorldFacingRoleQueryResult find_legacy_world_facing_role(
    std::span<const LegacyWorldRoleRecord> roles, compat::u32 role_count,
    compat::u32 player_index, compat::i32 delta_x, compat::i32 delta_y,
    compat::u32 map_width, compat::u32 map_height) noexcept;
