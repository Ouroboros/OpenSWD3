...
struct LegacyWorldFrameRuntimePorts {
  // Every 0x00412930 stage except 0x00413EA0 and 0x00413870 remains explicit
  // here until its owning module supplies a concrete runtime implementation.
...
// assembly order while the two recovered spatial stages execute against the
// same role array, raster clip, framebuffer and row-jitter state.
