...
[[nodiscard]] LegacyActionDrawResult update_draw_legacy_action(
...
[[nodiscard]] LegacyActionDrawResult draw_legacy_tsw_frame(
    compat::u32 resource_id_slot,
    compat::u32 frame_index_slot,
    compat::i32 x,
    compat::i32 y,
    LegacyActionDrawPorts& ports
);
...
[[nodiscard]] LegacyActionDrawResult update_draw_legacy_action_with_flags(
    LegacyActionRecord& record,
    compat::i32 x,
    compat::i32 y,
    compat::u32 caller_flags,
    LegacyActionDrawPorts& ports
);
