...
public:
  ...
  [[nodiscard]] virtual bool resolve_role_position(compat::u16 role_selector,
                                                   compat::i16 &world_x,
                                                   compat::i16 &world_y) = 0;
};
...
public:
  ...
  [[nodiscard]] virtual rendering::LegacyBlitExecutionStatus draw_frame_piece(
      const rendering::LegacyFramePiece &piece, compat::i32 destination_x,
      compat::i32 destination_y, compat::u32 flags, compat::i32 red_offset,
      compat::i32 green_offset, compat::i32 blue_offset) noexcept = 0;
};
...
public:
  ...
  [[nodiscard]] rendering::LegacyBlitExecutionStatus draw_frame_piece(
      const rendering::LegacyFramePiece &piece, compat::i32 destination_x,
      compat::i32 destination_y, compat::u32 flags, compat::i32 red_offset,
      compat::i32 green_offset, compat::i32 blue_offset) noexcept override;
...
public:
  ...
  [[nodiscard]] LegacyAniRoleParticleResult
  update(compat::i32 role_world_x, compat::i32 role_world_y,
         compat::u16 role_selector, compat::i32 legacy_map_id,
  ...
  [[nodiscard]] std::array<LegacyAniRoleParticleEmitter,
                           kLegacyAniRoleParticleEmitterCount> &
  emitters() noexcept;
  [[nodiscard]] const std::array<LegacyAniRoleParticleEmitter,
                                 kLegacyAniRoleParticleEmitterCount> &
