...
struct LegacyAniDirectionalState {
    std::array<
        LegacyAniDirectionalMotionSlot,
        kLegacyAniDirectionalPhysicalSlotCount>
        motion{};
    std::array<
        LegacyAniDirectionalColorSlot,
        kLegacyAniDirectionalPhysicalSlotCount>
        color{};
    std::array<
        LegacyAniDirectionalTimingSlot,
        kLegacyAniDirectionalPhysicalSlotCount>
        timing{};
};
...
public:
    ...
    // the first two.
    [[nodiscard]] LegacyAniDirectionalInitializationResult initialize_slots(
        const LegacyAniDirectionalConfiguration& configuration,
        input_time_rng::LegacySecondaryRng& random
    ) noexcept;

    [[nodiscard]] LegacyAniDirectionalResult update(
        const LegacyAniDirectionalConfiguration& configuration,
